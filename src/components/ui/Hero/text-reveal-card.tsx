    ...
    >
      ...
      <div className="h-40  relative flex j items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-[#020203] z-20  will-change-transform"
        >
          <p
            style={{
              textShadow: "4px 4px 15px rgba(0,0,0,0.5)",
            }}
            className="text-base sm:text-[4rem] py-10 font-bold text-[#323238] bg-clip-text text-transparent bg-gradient-to-b from-[#323238] to-neutral-300"
          >
            {revealText}
          </p>
        </motion.div>
...
export const TextRevealCardDescription = ({
  ...
  return (
    <p className={twMerge("text-[#a9a9a9] text-base", className)}>{children}</p>
  );
};
